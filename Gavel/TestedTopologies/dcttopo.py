...
class FatTreeTopo(StructuredTopo):
    ...
    def __init__(self, k = 4, speed = 1.0):
        ...
        for p in pods:
            for e in edge_sws:
                ...
                self.edgeSwitches[edge_id] = edge_opts
                ...
                for a in agg_sws:
                    ...
                    self.aggrSwitches[agg_id] = agg_opts
            ...
            for a in agg_sws:
                ...
                for c in core_sws:
                    ...
                    self.coreSwitches[core_id] = core_opts
  ...
  # you can simply add the key and value of host id and **host_opt by pass them later to node graph simply. check port 0 is not there. 
  #also create another relationship between two host to indicate connected or all switch port. 2 relationship connected_to, can_reach
