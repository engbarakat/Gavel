...
def getroute(srcIP, dstIP,session = None):
	...
	for pathins in result:
		return pathins["pa.switches"]#msgOF("installflow",switches = pathins["pa.switches"],portsforward = pathins["pa.fports"],portsbackward = pathins["pa.bports"] , srcip = srcIP, dstip =dstIP,srcmac=pathins["h1.mac"],dstmac= pathins["h1.mac"])
		return True
	return False
